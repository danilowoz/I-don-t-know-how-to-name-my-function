...
const classNames = {
  ...
  tabRegular:
    'inline-flex items-center transition-all duration-300 ease-in focus:outline-none hover:text-indigo-600 rounded-l-full px-4 py-2 active',
    ...
    <>
      ...
      */}
      ...
      <input
        ...
        className="mt-3 w-full appearance-none border rounded py-2 px-3 text-grey-darker"
      />
